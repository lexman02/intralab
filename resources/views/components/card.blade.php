...
<a href="{{ $url }}"
   class="relative group bg-gray-700/80 py-3 md:py-4 sm:py-20 sm:w-60 flex flex-col items-center cursor-pointer rounded-md hover:bg-gray-700/40 hover:smooth-hover">
