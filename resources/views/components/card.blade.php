...
<a href="{{ $url }}" class="relative group bg-gray-700/80 py-3 md:py-4 sm:py-20 sm:w-60 flex flex-col items-center cursor-pointer rounded-md hover:bg-gray-700/40 hover:smooth-hover">
...
{{--    </p>--}}
    ...
    <img class="w-1/6 sm:w-3/12 object-cover object-center rounded-full mb-1.5" src="https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/{{ $icon }}.png" alt="{{ $icon . '_icon' }}" />
