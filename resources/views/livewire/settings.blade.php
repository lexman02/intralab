        ...
        <div x-cloak x-data="{ selectedTab: @entangle('uploadMethod').defer}" x-show="confirmed"
            ...
            <div x-show="selectedTab === 'input'" class="flex justify-center h-60">
                <form wire:submit.prevent="import"
                      ...
                      id="input">
                    <label for="input-textbox" class="text-white/70 self-start sr-only">Paste your config here</label>
                    @error('config')
                    <div
                    ...
                    @enderror
                    <textarea data-gramm="false" autocomplete="off" autocorrect="off" autocapitalize="off"
                              spellcheck="false" id="input-textbox" wire:model="config" placeholder="Paste config here"
