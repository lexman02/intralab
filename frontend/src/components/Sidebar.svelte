<script>
    ...
    function getProps({ location, href, isPartiallyCurrent, isCurrent }) {
        ...
        if (isActive) {
            return { class: "bg-gray-800 text-white" };
        }
        return {};
    }
</script>
...
<div class="bg-gray-900 px-2 lg:px-4 py-2 lg:py-10 sm:rounded-xl flex lg:flex-col justify-between">
    <nav class="flex items-center flex-row space-x-2 lg:space-x-0 lg:flex-col lg:space-y-2">
        ...
        <Link class="text-white/50 hover:bg-gray-800 hover:text-white smooth-hover p-4 inline-flex justify-center rounded-md"
           to="/" {getProps}>
