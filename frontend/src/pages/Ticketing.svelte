...
<div>
    ...
    <form on:submit|preventDefault={submit} class="space-y-4" id="ticket">
        ...
        <div class="text-left text-white/60 font-medium">
            ...
            <textarea form="ticket"
                      ...
                      id="message"
                      required
                      class="bg-gray-700/50 rounded-lg text-sm h-48 w-full mt-1 text-white/75 caret-white p-2.5 resize-none border-0 ring-1 ring-slate-900/10 focus:outline-none placeholder:font-medium placeholder:text-white/20"></textarea>
        </div>
        <button type="submit"
